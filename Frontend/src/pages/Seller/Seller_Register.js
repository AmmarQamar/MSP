    ...
    <Box sx={boxstyle}>
      <Box sx={center}>
        <div style={{ margin: "auto" }}>
          <Avatar sx={{ p: 1, bgcolor: "#ffffff", margin: "auto" }}>
        ...
        <Stack spacing={2}>
          ...
          <SignUpTextField
            ...
            value={seller.reEnterPassword}
            onChange={handleChange}
          ></SignUpTextField>
          <Button variant="contained" sx={SignUpButton} onClick={handleSubmit}>
            {" "}
            SignUp
          </Button>
          <StyledLink to="/login" style={{ textAlign: "center" }}>
